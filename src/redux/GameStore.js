...
export const GameAssets = createSlice({
    name: "GameAssets",
    initialState: {
        running_spritesheet_url: "https://s3.amazonaws.com/utoon-animator/Animations/SpriteSheets/ZQMveebZkb_Running_sprite_sheet.png",
        jump_spritesheet_url: null,
        idle_spritesheet_url: "https://s3.amazonaws.com/utoon-animator/Animations/SpriteSheets/ZQMveebZkb_Idle_sprite_sheet.png"
    },
    reducers: {
