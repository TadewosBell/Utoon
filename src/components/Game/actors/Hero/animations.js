...
export const animationMap = {
  IDLE: [astro_Idle, astro_Idle, idleShoot, idleShootRight],
  YMCA: [astro_ymca],
...
// import * as ex from 'excalibur';
// import { Images } from "../../resources.js";
// // import { animationMap, heroAnimations } from './animations';

// export default function AnimationMap({ astroRunningSheet }) {
//   const animationMap = {}
//   const heroAnimations = {}

//   useEffect(() => {
//     // if astroRunning is undefined return 
//     const heroSpriteSheet = ex.SpriteSheet.fromImageSource({
//       image: Images.heroSheetImage,
//       grid: {
//         columns: 10,
...
//     const astro_run_sheet = ex.SpriteSheet.fromImageSource({
//       image: astroRunningSheet? astroRunningSheet : Images.astroRunningSheet,
//       grid: {
//         columns: 20,
//         rows: 1,
//         spriteWidth: 1500/20,
...
//   const getAnimation = (name, isFacingRight) => {
//     const anims = animationMap[name];
//     if (isFacingRight) {
//       return anims[1] || anims[0]; 
//     } else {
//       return anims[0];
//     }
//   }
